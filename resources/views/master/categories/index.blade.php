<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-2xl text-gray-900">Kategori Barang</h2>
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="text-left bg-gray-50 border-b border-gray-200">
                                <th class="py-3 px-4 font-semibold text-gray-700">Nama Kategori</th>
                            ...
                            @empty
                                <tr>
                                    <td colspan="2" class="py-12 text-center">
                                        ...
                                        <p class="text-gray-400 text-sm mt-1">Silakan tambah kategori barang baru</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
