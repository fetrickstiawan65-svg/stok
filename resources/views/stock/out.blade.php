<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-2xl text-gray-900">Stok Keluar Manual</h2>
    </x-slot>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   ...
                                   class="w-full px-3 py-2 border-gray-300 rounded-lg shadow-sm focus:border-primary-500 focus:ring-primary-500" 
                                   placeholder="1" />
                            <p class="text-xs text-gray-500 mt-1">Jumlah barang yang akan dikurangi dari stok</p>
                        ...
                        <div>
                            ...
                            <textarea name="notes" 
                                      rows="2"
                                      class="w-full px-3 py-2 border-gray-300 rounded-lg shadow-sm focus:border-primary-500 focus:ring-primary-500" 
                                      placeholder="Contoh: Barang rusak, hilang, atau terpakai">{{ old('notes') }}</textarea>
                        </div>
