<x-guest-layout>
    ...
    <div class="text-center mb-8">
        <div class="inline-flex bg-green-100 rounded-full p-3 mb-4">
            <svg class="w-8 h-8 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
            </svg>
        </div>
        <h2 class="text-2xl font-bold text-gray-900">Verifikasi Email</h2>
        <p class="text-sm text-gray-500 mt-2">Terima kasih telah mendaftar! Silakan verifikasi alamat email Anda dengan klik link yang sudah kami kirim.</p>
    </div>
    ...
    @if (session('status') == 'verification-link-sent')
        <div class="mb-4 p-4 bg-green-50 border border-green-200 rounded-lg">
            <div class="flex items-center">
                ...
                <p class="text-sm font-medium text-green-700">Link verifikasi baru telah dikirim ke email Anda.</p>
            </div>
        </div>
    @endif
